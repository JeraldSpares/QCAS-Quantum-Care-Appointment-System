...
<style>
    /* Minimal padding for overall structure */
    .row.p-2, .col-mobile, .board-box, .table-style {
        padding: 2px 5px;
        margin: 0;
    }
    ...
    /* Employee Badge for Google Sync Status */
    .employee-badge i {
        font-size: 16px;
        color: #28a745;
    }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\jeral\OneDrive\Desktop\Quantum Care Appointment System\resources\views/employees/index.blade.php ENDPATH**/ ?>