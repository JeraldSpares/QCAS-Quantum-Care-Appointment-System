...
<head>
    ...
    <title><?php echo e(__('Verify Mail Configuration')); ?></title>
</head>
<body>
                        ...
                        <td style="padding:15px 20px 0 20px;background:#fff">
                            <table style="width:100%;margin:auto;border-bottom:1px solid #ebecf2;padding-bottom:15px">
                                <tbody>
                                    <tr>
                                        <td>
                                            <h2 style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;margin:5px 0;font-size:16px;font-weight:bold;color:#1e2538;line-height:22px"><?php echo e(__('Verify Mail Configuration')); ?></h2>
                                        </td>
                                        <td>
                                ...
                                <tbody><tr>
                                    <td style="padding:10px;text-align:center;">
                                        <p style="font-family:Roboto,RobotoDraft,Helvetica,Arial,sans-serif;margin:0;font-size:16px;font-weight:bold;color:#000000;line-height:20px;margin-bottom:5px">
                                            <?php echo e(__('Hi,  This email sent for Test Email Configuration Settings. You can received this email. email configuration is correct.')); ?>
...
</html><?php /**PATH C:\Users\jeral\OneDrive\Desktop\readybook-appointment-booking-code-1.4\resources\views/mail/verify_smtp.blade.php ENDPATH**/ ?>