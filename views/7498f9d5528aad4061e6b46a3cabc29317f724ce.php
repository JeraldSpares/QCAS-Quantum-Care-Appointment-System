    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0">
            <div class="modal-header px-5 position-relative modal-shape-header bg-shape">
                <h5 class="modal-title" id="staticBackdropLabel"><?php echo e(__('Reset Password')); ?></h5>
            ...
            <div class="modal-body py-4 px-5">
                <form action="<?php echo e(route('password.reset.form')); ?>" method="post" id="reset-password-form" autocomplete="off">
                    ...
                    <div class="row gx-2">
                        ...
                        <div class="mb-3 col-sm-12">
                                ...
                                <input class="form-control" type="text" name="email" id="emailAddress" value="<?php echo e(isset($email) ? $email : ''); ?>"
                                autocomplete="off" placeholder="<?php echo e(__('Enter Email')); ?>" readonly/>
                        ...
                        <div class="mb-3 col-sm-12">
                                ...
                                <input class="form-control" type="password" name="password" id="new-passwords"
                                    autocomplete="off" placeholder="<?php echo e(__('Enter Password')); ?>" />
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="mb-3"><button class="btn btn-primary d-block w-100 mt-3" type="submit"
                            name="submit"><?php echo e(__('Submit')); ?></button></div>
                        </div>
...
<?php /**PATH C:\Users\jeral\OneDrive\Desktop\readybook-appointment-booking-code-1.4\resources\views/theme/includes/reset-password.blade.php ENDPATH**/ ?>