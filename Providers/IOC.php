...
class IOC extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind("App\\Repositories\\Interfaces\\IPaymentRepository", "App\\Repositories\\Implementations\\PaymentRepository");
        $this->app->bind("App\\Http\\Services\\Interfaces\\IPaymentService", "App\\Http\\Services\\Implementations\\PaymentService");

        $this->app->bind("App\\Repositories\\Interfaces\\ICategoryRepository", "App\\Repositories\\Implementations\\CategoryRepository");
        $this->app->bind("App\\Http\\Services\\Interfaces\\ICategoryService", "App\\Http\\Services\\Implementations\\CategoryService");
