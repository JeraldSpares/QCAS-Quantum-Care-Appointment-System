                        ...
                        <div class="card-body pb-1">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="padding-space">
                                    ...
                                    @else
                                    <img src="{{ asset('rbtheme/img/logoo.png') }}" class="bg-image" alt="{{ __('favicon') }}" id="faviconimage" height="50px" width="50px">
                                    @endif
                                </div>
                            </div>
                            <div class="mb-3">
                                ...
                                @else
                                <div class="padding-space"><img src="{{ asset('rbtheme/img/logoo.png') }}" class="bg-image" alt="{{ __('Logo') }}" id="logoimage"  height="80px"></div>
                                @endif
                            </div>
