                ...
                <tbody>
                    ...
                    <tr>
                        <td style="padding:5px 20px 0">
                            ...
                            for {{date('d F Y', strtotime($date))}}.</p>
                        </td>
                    </tr>
                    <tr>
