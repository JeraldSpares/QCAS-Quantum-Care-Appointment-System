...
<section id="hero" class="d-flex align-items-center">
    ...
    <div class="container">
        <div class="row">
            ...
            <h1>{{ __('Choose') }} <span class="typed-text fw-bold" data-typed-text='["{{ __('Service') }}","{{ __('Employee')}}", "@if($custom->employees == 1){{ __('Date')}}@endif","{{ __('Time')}}"]'></span><br> {{ __('For Your Appointment') }}</h1>
